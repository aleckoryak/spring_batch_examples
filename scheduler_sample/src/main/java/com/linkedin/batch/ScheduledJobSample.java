...
public class ScheduledJobSample {
	...
	public Step step() throws Exception {
		return this.stepBuilderFactory.get("step").tasklet(new Tasklet() {
			...
			public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
				...
				System.out.println("The chunkContext is: " + chunkContext);
				System.out.println("The contribution is: " + contribution);
	...
	public Job scheduledJob() throws Exception {
		return this.jobBuilderFactory.get("scheduledJob").start(step()).build();
	}

	public static void main(String[] args) {
		SpringApplication.run(ScheduledJobSample.class, args);
	}
